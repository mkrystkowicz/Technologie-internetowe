<div class="container">
  <p class="desc">
    Naszym celem, zgodnie z naszym sloganem jest zapewnienie domowego jedzenia w przystępnej cenie.
  </p>
  <p class="desc">Przekonaj się sam wybierając naszą oferte</p>
  <nav>
    <ul>
      <li><a href="/?menuType=index&cartId=<?php echo $cartId ?>">Strona glówna</a></li>
      ...
      <li><a href="?menuType=christmasDishes&cartId=<?php echo $cartId; ?>">Dania świąteczne</a></li>
