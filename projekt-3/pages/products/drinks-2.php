  ...
  <main>
    <div class="container">
      <div class="navigation-btn-container">
        <a href="../drinks.php"><button class="btn">
            < Powrót</button></a>
      </div>
      <div class="product-container">
        <img src="/assets/product-images/herbata.jpeg" alt="herbatka" />
        <p class="desc">
          Jeśli potrzebujesz się rozgrzać, możemy zaoferować ciepłą herbatkę - w sam raz na chłodne wieczory.
        </p>
